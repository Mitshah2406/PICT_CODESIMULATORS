window.onload = async function () {
  ...
  //             lon: 73.855504,
  //             formattedAddress:
  //               "GVG4+26C, Tophakhana, Shivajinagar, Pune, Maharashtra 411005, India",
  //           },
  //           depotCapacity: null,
  ...
  //             lon: 73.847709,
  //             fotmattedAddress:
  //               "350/1, Laxmi Rd, Narayan Peth, Pune, Maharashtra 411030, India",
  //           },
  //           binFillLevel: 8,
  //           binFillLevelInKg: 10,
  //           binCapacityInKg: 40,
  ...
  //             lon: 73.85738,
  //             fotmattedAddress:
  //               "1115, Thorale Madhavarao Peshve Path, Subhash Nagar, Shukrawar Peth, Pune, Maharashtra 411002, India",
  //           },
  //           binFillLevel: 2,
  //           binFillLevelInKg: 10,
  //           binCapacityInKg: 40,
  ...
  //             lon: 73.851751,
  //             fotmattedAddress:
  //               "HV42+QQ6, Khadki Railway Station Rd, Opp. Khadki Court, Khadki, Pune, Maharashtra 411003, India",
  //           },
  //           binFillLevel: 8,
  //           binFillLevelInKg: 10,
  //           binCapacityInKg: 40,
  ...
  //             lon: 73.852183,
  //             fotmattedAddress:
  //               "HV32+FVG, Adarsh Nagar Bhaiya Wadi, Bhaiya Wadi, Khadki, Pune, Maharashtra 411003, India",
  //           },
  //           binFillLevel: 2,
  //           binFillLevelInKg: 10,
  //           binCapacityInKg: 40,
  ...
  //             lon: 73.884455,
  //             fotmattedAddress:
  //               "FVXM+2M4, Pune Cantonment, Pune, Maharashtra 411001, India",
  //           },
  //           binFillLevel: 1,
  //           binFillLevelInKg: 10,
  //           binCapacityInKg: 40,
  ...
  //             lon: 73.85305,
  //             fotmattedAddress:
  //               "FV53+W9X, Bharati Vidyapeeth Campus, Dhankawadi, Pune, Maharashtra 411043, India",
  //           },
  //           binFillLevel: 4,
  //           binFillLevelInKg: 10,
  //           binCapacityInKg: 40,
  ...
  //             lon: 73.812529,
  //             fotmattedAddress:
  //               "FRX7+523, Lane Number 17, Dahanukar Colony, Kothrud, Pune, Maharashtra 411038, India",
  //           },
  //           binFillLevel: 1,
  //           binFillLevelInKg: 10,
  //           binCapacityInKg: 40,
  ...
  //             lon: 73.862144,
  //             fotmattedAddress:
  //               "163, Lane, 11, Mahatma Society, Kothrud, Pune, Maharashtra 411029, India",
  //           },
  //           binFillLevel: 2,
  //           binFillLevelInKg: 10,
  //           binCapacityInKg: 40,
  ...
  //             lon: 73.803431,
  //             fotmattedAddress:
  //               "Mahtoba Nagar, Lane No 1, Matoba Nagar, Kothrud, Pune, Maharashtra 411038, India",
  //           },
  //           binFillLevel: 2,
  //           binFillLevelInKg: 10,
  //           binCapacityInKg: 40,
  ...
  //             lon: 73.842368,
  //             fotmattedAddress:
  //               "GRGR+7XW, Sud Nagar, Shivajinagar, Pune, Maharashtra 411005, India",
  //           },
  //           binFillLevel: 1,
  //           binFillLevelInKg: 10,
  //           binCapacityInKg: 40,
  ...
  //             lon: 73.887893,
  //             fotmattedAddress:
  //               "GVXQ+Q4C, Kamraj Nagar Rd, Janta Nagar, Yerwada Village, Yerawada, Pune, Maharashtra 411006, India",
  //           },
  //           binFillLevel: 4,
  //           binFillLevelInKg: 10,
  //           binCapacityInKg: 40,
  ...
  //             lon: 73.878791,
  //             fotmattedAddress:
  //               "120/205, Rto Office Area, Yerawada, Pune, Maharashtra 411006, India",
  //           },
  //           binFillLevel: 4,
  //           binFillLevelInKg: 10,
  //           binCapacityInKg: 40,
  ...
  //             lon: 73.852328,
  //             fotmattedAddress:
  //               "B/4, Sphurti Society, Wakadewadi, Shivajinagar, Pune, Maharashtra 411003, India",
  //           },
  //           binFillLevel: 1,
  //           binFillLevelInKg: 10,
  //           binCapacityInKg: 40,
...
async function initMap(single_truck_route) {
  ...
  // Add markers, polylines, etc., based on the single_truck_route data
}
