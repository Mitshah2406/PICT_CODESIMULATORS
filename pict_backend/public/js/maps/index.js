...
=======
    ...
    console.log(routess);
    var mapOptions = {
        center: new google.maps.LatLng(routess.truck_routes[0][0].depotLocation.lat, routess.truck_routes[0][0].depotLocation.lon),
        zoom: 10,
        mapTypeId: google.maps.MapTypeId.ROADMAP
    };
...
>>>>>>> 0f107479abc666590e62aff2b4d0642a9a1fd0db
                }
              }
            }
<<<<<<< HEAD
